# Generated by Django 5.1.6 on 2025-02-25 21:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trumbnail', models.ImageField(blank=True, default='default.jpg', upload_to='images/trumbnails/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpg', 'webp', 'jpeg', 'gif'])], verbose_name='Фотографии поста')),
                ...
                ('author', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='author_posts', to=settings.AUTH_USER_MODEL, verbose_name='Автор поста')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['-create', '-fixed', 'status'], name='blog_post_create_c9c369_idx')],
            },
        ),
    ]
